                ...
                <div class="set_quiz_section col-sm-12">
                    <form class="form-horizontal col-sm-10 quiz_form" method="post" action="<?php echo $this->webroot;?>students/add" role="form" id="add_student_form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="data[Student][email]" value="<?php echo $this->request->data['Student']['email'];?>" class="form-control" id="q_name" placeholder="Quiz Name">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3" for="name">Roll:</label>
                            <div class="col-sm-9">
                                <input type="text" name="data[Student][roll]" value="<?php echo $this->request->data['Student']['roll'];?>" class="form-control" id="s_name" placeholder="Subject">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="data[Student][mobile]" data-format="+880 dddd-dddddd" value="<?php echo $this->request->data['Student']['mobile'];?>" class="form-control bfh-phone" id="s_name" placeholder="Subject">
                            </div>
                        </div>
                        <div class="form-group">
